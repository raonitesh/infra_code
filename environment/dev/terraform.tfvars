...
vms = {
  vm1 = {
    name                            = "vm-todo-frontend11"
    location                        = "west us"
    resource_group_name             = "rg-todo11"
    size                            = "Standard_D2s_v3"
    disable_password_authentication = false
    nic_name                        = "nic-frontend"
    kv_name                         = "kv-todo-apps11"
...
sql_servers = {
  sql1 = {
    name                                     = "ershapp-dev-west-us-sqlsrv11"
    resource_group_name                      = "rg-todo11"
    location                                 = "west us"
    version                                  = "12.0"
    kv_name                                  = "kv-todo-apps11"
...
sql_databases = {
  sql_db1 = {
    name                = "todo-database11"
    server_name         = "ershapp-dev-west-us-sqlsrv11"
    resource_group_name = "rg-todo11"
    location            = "west us"
    sku_name            = "S0"
    max_size_gb         = 10
